...
## [1.3.0] 2019-05-03
### Bug fixing
- Renamed `src/layouts/Dashboard/Accueil.jsx` to `src/layouts/Admin.jsx`
- Renamed `src/views/Dashboard/Accueil.jsx` to `src/views/Accueil.jsx`
- Renamed `src/views/Dashboard/Accueil.jsx` to `src/views/Icons.jsx`
- Renamed `src/views/Dashboard/Accueil.jsx` to `src/views/Maps.jsx`
- Renamed `src/views/Dashboard/Accueil.jsx` to `src/views/Notifications.jsx`
- Renamed `src/views/Dashboard/Accueil.jsx` to `src/views/TableList.jsx`
- Renamed `src/views/Dashboard/Accueil.jsx` to `src/views/Typography.jsx`
- Renamed `src/views/Dashboard/Accueil.jsx` to `src/views/Upgrade.jsx`
- Renamed `src/views/Dashboard/Accueil.jsx` to `src/views/UserProfile.jsx`
...
- Renamed `App/App.jsx` to `Dashboard/Accueil.jsx`
